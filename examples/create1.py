...
if __name__ == "__main__":
    ...
    librml.actions.append(
        Action(
            ...
            restrictions=[
                ...
                Restriction(
                    res_type=RestrictionType.AGREEMENT, agreement_required=True
                ),
            ],
        )
    )
    ...
    download_restriction: str = json.dumps(
        {
            "type": "download",
            "permission": True,
            "restrictions": [{"type": "date", "fromdate": "2026-02-11"}],
        }
    )
    ...
    print(
        etree.tostring(
            xml, method="xml", pretty_print=True, xml_declaration=True
        ).decode("utf-8")
    )
